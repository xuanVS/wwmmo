...
public final class EmpireCashAuditEntry extends Message {
  ...
  private EmpireCashAuditEntry(Builder builder) {
    this(builder.key, builder.empire_key, builder.difference, builder.old_cash, builder.new_cash, builder.reason, builder.time);
    setBuilder(builder);
  }

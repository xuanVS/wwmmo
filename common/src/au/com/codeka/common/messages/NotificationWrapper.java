...
public final class NotificationWrapper extends Message {
  ...
  private NotificationWrapper(Builder builder) {
    this(builder.original_message, builder.notifications);
    setBuilder(builder);
  }
  ...
  public int hashCode() {
    ...
    if (result == 0) {
      ...
      result = result * 37 + (notifications != null ? notifications.hashCode() : 1);
      hashCode = result;
    }
    return result;
  }

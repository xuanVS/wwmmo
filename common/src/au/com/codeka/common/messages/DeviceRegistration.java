...
public final class DeviceRegistration extends Message {
  ...
  private DeviceRegistration(Builder builder) {
    this(builder.key, builder.device_id, builder.gcm_registration_id, builder.device_model, builder.device_manufacturer, builder.device_build, builder.device_version, builder.user);
    setBuilder(builder);
  }

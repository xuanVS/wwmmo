...
public final class EmpirePresence extends Message {
  ...
  private EmpirePresence(Builder builder) {
    this(builder.key, builder.empire_key, builder.star_key, builder.total_goods, builder.total_minerals, builder.goods_delta_per_hour, builder.minerals_delta_per_hour, builder.max_goods, builder.max_minerals, builder.goods_zero_time);
    setBuilder(builder);
  }

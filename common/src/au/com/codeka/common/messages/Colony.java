...
public final class Colony extends Message {
  ...
  private Colony(Builder builder) {
    this(builder.key, builder.empire_key, builder.star_key, builder.planet_index, builder.population, builder.DEPRECATED_last_simulation, builder.focus_population, builder.focus_farming, builder.focus_mining, builder.focus_construction, builder.delta_population, builder.delta_goods, builder.delta_minerals, builder.uncollected_taxes, builder.defence_bonus, builder.max_population, builder.cooldown_end_time);
    setBuilder(builder);
  }
